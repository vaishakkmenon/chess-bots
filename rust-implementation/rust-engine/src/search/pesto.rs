...
pub const QUEEN_VAL: (i32, i32) = (1025, 968);
pub const KING_VAL: (i32, i32) = (0, 0);

// Piece-Square Tables
// Format: [Rank 1 (a1-h1), Rank 2 (a2-h2), ... Rank 8 (a8-h8)]
...
pub const KING_TABLE: ([i32; 64], [i32; 64]) = (
    // MG - NOTICE THE E1/D1 PENALTIES AND CASTLING BONUSES
    [
    ...
    // EG - NOTICE THE CENTRALIZATION REWARDS
    [
